...
public class ErrorUniqueName extends JDialog {
	...
	public ErrorUniqueName() {
		...
		getContentPane().add(contentPanel, BorderLayout.EAST);
		{
			...
			lblErrorMessage.setIcon(new ImageIcon("C:\\Users\\Nobutaka\\workspace\\tamagochi\\Images\\ErrorUniqueName.png"));
